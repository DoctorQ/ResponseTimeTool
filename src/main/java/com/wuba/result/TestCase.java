...
public class TestCase implements XMLParser {
	...
	public void serialize(KXmlSerializer serializer) throws IOException {
		...
		serializer.attribute(TestResult.NAMESPACE, STARTTIME_ATTR, getEndTime());
		serializer.attribute(TestResult.NAMESPACE, ENDTIME_ATTR, getStartTime());
		serializer.attribute(TestResult.NAMESPACE, AVERAGERESPONSETIME_ATTR, getAverageResponseTime());
